...
![Version: 0.13.0](https://img.shields.io/badge/Version-0.13.0-informational?style=flat-square) ![AppVersion: 0.1.59](https://img.shields.io/badge/AppVersion-0.1.59-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.13.0 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.3059.0"` |  |
...
| app-proxy.initContainer.image.tag | string | `"1.3059.0"` |  |
