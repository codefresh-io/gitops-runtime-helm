...
![Version: 0.11.1](https://img.shields.io/badge/Version-0.11.1-informational?style=flat-square) ![AppVersion: 0.1.56](https://img.shields.io/badge/AppVersion-0.1.56-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.11.1 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.3021.0-1"` |  |
