...
![Version: 0.15.0](https://img.shields.io/badge/Version-0.15.0-informational?style=flat-square) ![AppVersion: 0.1.65](https://img.shields.io/badge/AppVersion-0.1.65-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.15.0 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.3180.0"` |  |
...
| app-proxy.initContainer.image.tag | string | `"1.3180.0"` |  |
