...
![Version: 0.16.2](https://img.shields.io/badge/Version-0.16.2-informational?style=flat-square) ![AppVersion: 0.1.67](https://img.shields.io/badge/AppVersion-0.1.67-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.16.2 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.3263.2"` |  |
...
| app-proxy.initContainer.image.tag | string | `"1.3263.2"` |  |
