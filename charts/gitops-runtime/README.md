...
![Version: 0.26.8](https://img.shields.io/badge/Version-0.26.8-informational?style=flat-square) ![AppVersion: 0.2.0](https://img.shields.io/badge/AppVersion-0.2.0-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.26.8 <local_registry>
```
...
```
docker run -e EXTERNAL_ARGOCD=true  -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.26.8 <local_registry>
```
...
| app-proxy.image.tag | string | `"62b923f"` |  |
...
| app-proxy.initContainer.image.tag | string | `"62b923f"` |  |
