...
| argo-workflows.server.baseHref | string | `"/workflows/"` | Do not change. In the runtime workflows UI is accessed only through internal-router /workflows/ location. Changing this value will break it. |
