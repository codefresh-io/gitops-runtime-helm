...
![Version: 0.2.0-alpha-13](https://img.shields.io/badge/Version-0.2.0--alpha--13-informational?style=flat-square) ![AppVersion: 0.1.26-helm-alpha](https://img.shields.io/badge/AppVersion-0.1.26--helm--alpha-informational?style=flat-square)
...
| app-proxy.image.tag | string | `"1.2161.0"` |  |
| app-proxy.imagePullSecrets | list | `[]` |  |
| app-proxy.initContainer.command[0] | string | `"./init.sh"` |  |
| app-proxy.initContainer.env | object | `{}` |  |
| app-proxy.initContainer.image.pullPolicy | string | `"IfNotPresent"` |  |
| app-proxy.initContainer.image.repository | string | `"quay.io/codefresh/cap-app-proxy-init"` |  |
| app-proxy.initContainer.image.tag | string | `"1.2161.0"` |  |
