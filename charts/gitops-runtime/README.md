...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.15.1 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.3196.4"` |  |
...
| app-proxy.initContainer.image.tag | string | `"1.3196.4"` |  |
