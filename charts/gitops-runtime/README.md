...
![Version: 0.3.6](https://img.shields.io/badge/Version-0.3.6-informational?style=flat-square) ![AppVersion: 0.1.37](https://img.shields.io/badge/AppVersion-0.1.37-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:0.3.6 <local_registry>
```
...
| app-proxy.image.tag | string | `"1.2562.0"` |  |
...
| app-proxy.initContainer.image.tag | string | `"1.2562.0"` |  |
