...
{{/*
Create the name of the service account to use in promotion-template
*/}}
{{- define "gitops-operator.promotionTemplate.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default "promotion-template" .Values.promotionTemplate.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.promotionTemplate.serviceAccount.name }}
{{- end }}
{{- end }}
